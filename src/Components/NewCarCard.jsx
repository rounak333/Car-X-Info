    ...
    >
      <div className="relative bg-gradient-to-b from-gray-800 to-gray-900 bg-opacity-60 backdrop-blur-xl p-6 rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-500">
        ...
        <div className="relative overflow-hidden rounded-lg h-48 mb-4">
          <img
            src={car.imgUrl}
            alt={`${car.year} ${car.brand} ${car.carName}`}
        ...
        <div className="space-y-2 text-center">
          <h3 className="text-xl font-bold text-white tracking-wide">
            {car.year} {car.brand} {car.carName} <span className="text-sm text-gray-400">({car.trim})</span>
          </h3>
          <p className="text-gray-400 text-sm">{car.speed} speed | seat type {car.seatType}, ratings {car.ratings}</p>
          <p className="text-3xl font-bold text-purple-400 tracking-wide">
            {car.price}
          </p>
          <p className="text-gray-400 text-sm">{car.description}
          </p>
        </div>
