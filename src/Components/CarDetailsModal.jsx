      ...
      <div className="bg-opacity-30 bg-white/10 backdrop-blur-lg rounded-xl shadow-2xl border border-gray-700 max-w-3xl w-full relative p-8">
        ...
        <div className="flex flex-col md:flex-row text-white">
          ...
          <div className="md:ml-8 mt-4 md:mt-0 space-y-4">
            <h2 className="text-3xl font-extrabold tracking-wide neon-text mb-4">{car.make} {car.model}</h2>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="text-sm capitalize">{car.condition}</p>
              </div>
            </div>
          ...
          <div className="md:ml-8 mt-6 md:mt-0 space-y-4">
            ...
            <p className="text-sm">Dealer: {car.dealerName}</p>
            <p className="text-sm">Location: {car.city}, {car.state}</p>
          </div>
        </div>
      </div>
    </div>
